 ...
 */
@WebServlet("/SearchServletNormal")
public class SearchServletNormal extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PreparedStatement ps=connection.prepareStatement("select * from winter_internship where cust_number=?");
